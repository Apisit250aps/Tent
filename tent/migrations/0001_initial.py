# Generated by Django 4.2.6 on 2024-02-15 05:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sale_status', models.IntegerField(choices=[(1, 'Pending'), (2, 'Paid')])),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('car', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tent.car')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tent.customer')),
        ...
        migrations.AddField(
            model_name='finance',
            name='sale',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tent.sale'),
        ),
        migrations.AddField(
            model_name='employee',
            name='position',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tent.position'),
        ),
        migrations.AddField(
            model_name='employee',
            name='user',
